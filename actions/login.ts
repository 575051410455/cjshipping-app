...
import { generateTwoFactorToken } from '@/data/tokens/two-factor/create';
import { generateCustomVerificationToken } from '@/data/tokens/verification-email/create';
import { deleteCustomVerificationTokenById } from '@/data/tokens/verification-email/delete';
import { consumeTwoFactorToken, getUserLoginAuthData } from '@/data/user/login';
import { CustomLoginAuthError } from '@/lib/constants/errors/errors';
import { messages } from '@/lib/constants/messages/action/messages';
...
import type { VerifiedUserForAuth } from '@/types/types';
